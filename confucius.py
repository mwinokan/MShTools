...
quotes = [
			...
			"I'M STARTING TO BELIEVE THESE ARE NOT REAL CONFUCIUS QUOTES",
			"WOULD YOU RATHER MAKE LOVE TO AN EYE OR A FOOT?",
			"QUANTUM PHYSICS MEANS THAT\nANYTHING CAN HAPPEN AT ANY TIME,\nFOR NO REASON",
			"I WOULD BE SCHLOBBIN ON SOMEONE'S KNOB FOR THAT",
			"THERE IS NO GREAT LOVE, WITHOUT GREAT JEALOUSY",
			"THE BAD BOYS WON'T WAIT ALL NIGHT",
			"YOU WON'T BELIEVE WHAT THIS OLD ITALIAN MAN PUT IN MY MIND",
			"THERE'S NOTHING NATURAL ABOUT AVERAGING COORDINATES",
			"ONIONS DON'T HURT ME",
			"THAT WAS BEFORE I DISCOVERED TURKISH MEN",
			"ALL COSTS ARE SUBSTANTIAL",
			"ALWAYS A GOOD IDEA TO BLAME THE FRENCH",
			"CHEESE, SEX AND ALIENS",
			"YOU HAVE TO ACCEPT YOUR MISERY",
			"COSTA RICA WAS A SIMULATION WITH THE WRONG FORCE FIELD",
